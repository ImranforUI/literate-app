        ...
        <React.Fragment>
            <div className="container mt-5">
                <div className="row text-center">
                    <div className="col">
                        <h3 className="display-4 textLiterate">Why Study With Us?</h3>
                ...
                <div className="row">
                    <div className="col-md-4  my-3">
                        <div className="card literate-hover border-rounded">
                            <img src={Card1} alt="" className='bg-white border-rounded' />
                    ...
                    <div className="col-md-4 my-3">
                        <div className="card literate-hover border-rounded">
                            <img src={Card3} alt="" className='bg-white border-rounded' />
                            <div className="card-body text-center">
                    ...
                    <div className="col-md-4  my-3">
                        <div className="card literate-hover border-rounded">
                            <img src={Card2} alt="" className='bg-white border-rounded' />
                            <div className="card-body text-center">
