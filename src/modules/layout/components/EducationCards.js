    ...
    return (
        <React.Fragment>
            <div className="row text-center mt-5">
                <div className="col">
                    <h3 className="display-4">Education For Everyone</h3>
                    <p className="lead">Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti sit labore dolores aliquam possimus deleniti cupiditate temporibus, repudiandae suscipit asperiores vel.</p>
                </div>
            </div>
